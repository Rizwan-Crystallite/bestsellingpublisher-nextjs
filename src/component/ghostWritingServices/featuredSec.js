        ...
        <div className='max-w-7xl lg:max-w-6xl mx-auto text-center items-center justify-center'>
          ...
          <div className='mx-auto py-2 sm:w-[100%] xs:w-[90%] '>
                <div className='w-[30%] md:w-[60%] mx-auto grid grid-cols-2 grid-rows-1 gap-x-5 py-4 sm:w-[70%] xs:w-[100%]'>
                  <button className='bg-[#00C0E4] py-1 text-white border-solid border-[#00c0e4] border-[1px] hover:bg-transparent hover:border-solid hover:border-[1px] hover:border-[#1d1d1f] hover:text-[#1d1d1f]'>Get Started</button>
