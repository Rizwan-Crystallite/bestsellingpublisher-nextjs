            ...
            <section className="pt-[100px] md:py-20 sm:py-10 xs:py-10 font-secondary">
                <div className="container max-w-7xl lg:max-w-6xl">
                    <div className="text-center justify-content-center ">
                        <h6 className='text-xl font-semibold'>Why we are exceptional </h6>
                        <h2 className='text-[40px] font-semibold mb-2 lg:text-5xl py-3 md:text-4xl sm:text-3xl xs:text-4xl sm:py-5'>The Greatness of Our Team Cannot Be Understated</h2>
