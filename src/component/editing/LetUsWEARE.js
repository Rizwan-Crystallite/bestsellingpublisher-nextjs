                ...
                <div className='container max-w-7xl lg:max-w-6xl'>
                    <div className='flex gap-5 md:grid sm:grid sm:grid-cols-1 xs:grid xs:grid-cols-1 md:px-10'>
                        <div className='basis-[40%] items-center md:hidden sm:hidden xs:hidden'>
                            <Image quality={95} src='/assets/images/newimg/OJK93M1321.png' width={600} height={300} alt='Low Upfront Cost' className=' hover:-translate-y-1 hover:scale-110' />
                        </div>
                            ...
                            <div className='w-[90%] md:w-[100%]  xs:py-5 xs:px-5 sm:w-[100%] xs:w-[100%]'>
                                ...
                                <ul className="grid grid-cols-2 xs:grid-cols-1 md:w-[100%] xs:w-[100%] md:mb-10">
                                    <li className='flex gap-4 border-b-2 border-solid border-[#989898] py-3 mr-10 xs:mr-0 md:mr-5'>
                                        <Image quality={95} src="/assets/images/newimg/color-check1.png" width={25} height={25} alt="Checkmark" className="inline-block h-5 w-5 hover:invert-75" />
