            ...
            <section className="py-[40px] xs:py-10 font-secondary">
                <div className="container max-w-7xl relative z-10 ">
                    <div className="text-center justify-content-center ">
                        <h6 className='font-semibold text-xl'>Why we are exceptional </h6>
                        <h2 className='text-5xl font-bold capitalize sm:text-4xl xs:text-3xl py-3'>The greatness of our team cannot be understated</h2>
