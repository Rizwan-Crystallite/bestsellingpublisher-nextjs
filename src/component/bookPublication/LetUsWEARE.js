                    ...
                    <div className='flex gap-5 sm:grid sm:grid-cols-1 xs:grid xs:grid-cols-1'>
                        ...
                        <div className='basis-[60%] md:basis-[100%]'>
                            <div className=' xs:py-5'>
                                ...
                                <h1 className='py-4 font-semibold leading-[50px] text-[45px]  xs:text-4xl xs:w-[90%] '>
                                ...
                                <ul className="grid grid-cols-2 gap-x-5 xs:grid-cols-1 md:w-[100%] xs:w-[100%] md:mb-10">
                                    <li className='flex gap-4 border-b-2 border-solid border-[#707070] py-3'>
                                        <Image quality={95} src="/assets/images/newimg/color-check1.png" width={80} height={80} alt="Checkmark" className="inline-block h-5 w-5 hover:invert-75" />
